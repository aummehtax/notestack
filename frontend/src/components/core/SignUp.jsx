...
const SignUp = () => {
  ...
  return (
<div className={`w-full select-none relative h-screen flex justify-center items-center ${darkAndLight ? "bg-black" : "bg-white"} overflow-hidden`}>
      ...
      <div className="left w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[25%] h-auto sm:h-[58%] p-5 px-6 sm:px-13 py-6 rounded-md border-[#fe523b] z-30">
        ...
        <form action="" className="flex flex-col gap-5 mt-5">
          ...
          <div>
            <button type="submit" className="w-full h-10 cursor-pointer bg-[#fe523b] rounded-md font-medium">SIGN UP</button>
          </div>
          ...
          <a href="/login" className="text-center font-medium text-sm sm:text-base">Already have an account? <span className="font-bold">Login</span></a>
        </form>
